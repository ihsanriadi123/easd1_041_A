...
//dalam algorithma di klasifikasikan menjadi 2 data struktur.sebutkan 2 data struktur tersebut? Insertion sort dan quick sort
...
//sebutkan dari algorithma yang telah dipelajari mana yang termasuk kedalam quadratic dan mana yang termasuk kedalam logiliner? Quick sort
//buatlah sebuah program yang mengimplementasikan merge sort menggunakan bahasan c++.berikut merupakan algorithma merge sort?

#include <iostream>
using namespace std;

int ihsan[5];											// Membuat Array dengan panjang data 5
